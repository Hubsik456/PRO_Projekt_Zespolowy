...
def Widok_Main_Język():
    ...
    if REQUEST.method == "POST":
        if Formularz.validate_on_submit():
            ...
            Odpowiedź = MAKE_RESPONSE(
                REDIRECT(URL_FOR("Blueprint_1.Widok_Main_Index"))
            )  # Trzeba przeładować stronę, bez tego zmiana ciasteczka będzie wymagała ręcznego przeładowania strony
